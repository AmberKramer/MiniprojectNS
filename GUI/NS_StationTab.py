...
def actuelevertrekinformatie():
    """Deze def geeft de meest relevante informatie over de treinen weer, zorgt dat
    alles in tabellen komen te staan en zorgt dat alle defs van hier
    voor gebruikt worden als duidelijke tekst"""
...
#            #EindText += "Dit is een test versie! Let op!: Dit is alleen maar een testq"
        ...
        for r in regel:
            ...
            if "Let op" in r:
                ...
                button = tkinter.Button(Root, image=WarningLogo, text="!!!",
